...
public class DBMain {
	...
	public static void main(String[] args) {
		...
		List<ProductDTO> pList = productDAO.findProductDTOList();
...
//		}
		...
		Dept mdDept = deptDAO.findDeptByDeptno(30); //원본 데이터 조회
		System.out.println(mdDept);
		...
		//Professor saveP = new Professor(9091, "name", "id", "position", 111, 100, LocalDateTime.now(), 50, "email", "hpage" );
		Professor saveP = new Professor(9991, "name", "id", "position", 111, 100, "2025-06-01", 50, "email", "hpage" );
		int rs5 = professorDAO.saveProfessor(saveP);
		if(rs5 > 0) {
			System.out.println("saveP 저장 완료");
		}
	}
