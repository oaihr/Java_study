...
class Sample {
	...
	void addItem3(String s) throws Exception { // Exception 발생할 수 있으니까 처리해라
		list.add(s);
	}

	void addItem4(String s) throws NullPointerException { // Exception 발생할 수 있으니까 처리해라 (떠넘기기)
		try {
			list.add(s);
		} catch (Exception e) {
	...
	// throws: 메소드 선언부분 뒤에 붙여서, 예외 떠넘기기가 발생할 수 있다고 경고!!
	// throw: 실제로 예외 떠넘기기 수행!! "예외를 던져라"
