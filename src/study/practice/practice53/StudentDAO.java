...
//					deptList = new ArrayList<Dept>();
				...
				// 해당 행에 컬럼 단위로 데이터 접근
				StudentDTO Student = new StudentDTO(rs.getInt("studno"), rs.getString("name"), rs.getString("id"), rs.getInt("grade"), 
						rs.getString("jumin"), rs.getString("birthday"), rs.getString("tel"), rs.getInt("height"), rs.getInt("weight"),
						rs.getInt("deptno1"), rs.getInt("deptno2"), rs.getInt("profno"));
