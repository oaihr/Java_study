...
public class Professor {
	...
	//java.util.Date : Java에서 자체적으로 사용한느 타입 -> 요즘엔 LocalDate, LocalDateTime을 씀
	...
	public Professor(int profno, String name, String id, String position, int pay, int deptno, String hiredate, int bonus,
	...
	public String toString() {
		return "Professor [profno=" + profno + ", name=" + name + ", id=" + id + ", position=" + position + ", pay="
				+ pay + ", deptno=" + deptno + ", hiredate=" + hiredate + ", bonus=" + bonus + ", email=" + email
				+ ", hpage=" + hpage + "]";
	}
