...
//		전화번호는 OOO-OOOO-OOO 입니다.
		String phoneNumber = "010-1577-1541";
...
//		a. $ystem
//		b. channel#112 변수 이름에 공백이나 특수 문자는 사용할 수 없음  (_, $만 사용가능)
//		c. 7eleven  숫자로 시작할수 없음
//		d. newmember
//		e. $MAX_NUM
//		f. hello@com 변수 이름에 공백이나 특수 문자는 사용할 수 없음 (_, $만 사용가능)
