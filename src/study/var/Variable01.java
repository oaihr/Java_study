...
public class Variable01 {
	...
	public static void main(String[] args) {
		...
		int number1; 	// int: 정수형 숫자   공간이름: number1
		int floor; 		// 정수형 숫자를 담을 공간  (공간이름: floor)
		...
		System.out.println(3*20+30);    // sysout -> Ctrl + space 자동완성
		System.out.println(hour+ "시 " +minute+ "분");
		
		
		x = 10;
		y = x;
		z = x + y;   // x:10 y:10 z:20
